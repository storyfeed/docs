...
const ROWS: Row[] = [
  ...
  row('j11', '1985-06-28 10:30', 'merge', radio, pull(1), t.repo, 'splice'),
  row('j12', '1985-06-28 11:00', 'merge', radio, pull(2), t.repo, 'splice'),
  row('j13', '1985-06-28 11:40', 'merge', radio, pull(3), t.repo, 'splice'),
  ...
  row('j73', '1985-07-01 15:00', 'merge', radio, pull(4), t.repo, 'splice'),
  row('j74', '1985-07-01 15:10', 'approve', sweetheart, pull(5), null, 'splice', { uncertain: 'Suzie reviewing from Utah is ours' }),
  row('j75', '1985-07-01 15:30', 'merge', radio, pull(5), t.repo, 'splice'),
