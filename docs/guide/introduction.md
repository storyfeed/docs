...
| **actor / object / target / context** | the roles introduced above; [Recording](/basics/recording#roles) covers all seven | interchangeable; target ≠ context |
...
See the package's capabilities as snippet-and-result pairs in
[Usage examples](/guide/usage-examples), then
[install the package](/guide/installation) and build
